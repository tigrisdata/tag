...
// ordered against the object's current version); because other backends may
// silently ignore it, tiered mode issues this delete on Tigris only (the
// cleanup is disabled elsewhere — see deleteUpstreamObjectAsync).
