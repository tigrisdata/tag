...
func TestPutBlocksFromStream_ExactMultipleNoPhantomBlock(t *testing.T) {
	...
	if _, err := svc.putBlocksFromStream(context.Background(), wowBucket, wowKey, meta, strings.NewReader("ABCDEFGH"), 60, time.Now().UnixNano(), cache.VersionAny); err != nil {
...
func TestPutBlocksFromStream_MidStreamErrorLeavesMetaUnwritten(t *testing.T) {
	...
	if _, err := svc.putBlocksFromStream(context.Background(), wowBucket, wowKey, meta, r, 60, time.Now().UnixNano(), cache.VersionAny); err == nil {
...
func TestPutBlocksFromStream_TruncatedStreamLeavesNoShortBlockOrMeta(t *testing.T) {
	...
	if _, err := svc.putBlocksFromStream(context.Background(), wowBucket, wowKey, meta, strings.NewReader("ABCDEF"), 60, time.Now().UnixNano(), cache.VersionAny); err == nil {
