...
By signing this Agreement (for example, via the automated CLA check on a pull
request), You accept and agree to the following terms for Your present and
future Contributions submitted to Tigris. Except for the license granted herein
to Tigris and recipients of software distributed by Tigris, You reserve all
right, title, and interest in and to Your Contributions.

## 1. Definitions

"You" (or "Your") means the copyright owner or legal entity authorized by the
copyright owner that is making this Agreement with Tigris.

"Contribution" means any original work of authorship, including any
modifications or additions to an existing work, that is intentionally submitted
by You to Tigris for inclusion in, or documentation of, any of the products
owned or managed by Tigris (the "Work"). "Submitted" means any form of
electronic, verbal, or written communication sent to Tigris or its
representatives, including but not limited to communication on electronic
mailing lists, source code control systems, and issue tracking systems that are
managed by, or on behalf of, Tigris for the purpose of discussing and improving
the Work.

## 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant to
Tigris and to recipients of software distributed by Tigris a perpetual,
worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license
to reproduce, prepare derivative works of, publicly display, publicly perform,
sublicense, and distribute Your Contributions and such derivative works. Tigris
may license the Contributions under any license terms, including the Apache
License 2.0 under which the Work is released and, at Tigris's discretion, other
license terms.
...
litigation against You or any other entity alleging that Your Contribution, or
the Work to which You have contributed, constitutes direct or contributory
...
- If Your employer(s) has rights to intellectual property that You create that
  ...
  rights for Your Contributions to Tigris, or that Your employer has executed a
  separate Corporate CLA with Tigris.
- Each of Your Contributions is Your original creation (see Section 5 for
...
it to Tigris separately from any Contribution, identifying the complete details
...
You agree to notify Tigris of any facts or circumstances of which You become
